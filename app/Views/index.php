...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('buku');?>">Buku</a>
            </li>
            <li class="menu-item hidden"><a href="<?= base_url('pinjambuku');?>">Pinjam Buku</a></li>
            <li class="menu-item hidden"><a
                    href="<?= base_url('kategoribuku');?>">Kategori Buku</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <p><b>Nama: </b>M. Khoirul Risqi</p>
        <p><b>NIM: </b>221101023</p>
        <p><b>Kelas: </b>TI3A</p>
